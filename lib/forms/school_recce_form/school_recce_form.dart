                                                  ...
                                                  String selectedLanguage = getSelectedLanguage();
                                                    ...
                                                    SchoolRecceModal schoolRecceModal = SchoolRecceModal(
                                                        ...
                                                        udise_correct: schoolRecceController
                                                            .correctUdiseCodeController
                                                            .text,
                                                        boardImg: schoolRecceController.imagePaths.toString(),
                                                      buildingImg: schoolRecceController.imagePaths2.toString(),
                                                      ...
                                                      registerImg: schoolRecceController.imagePaths3.toString(),
                                                      ...
                                                      networkAvailability: schoolRecceController.getSelectedValue('networkConnectivity') ?? '',
                                                      digitalLearning: schoolRecceController.getSelectedValue('learningFacility') ?? '',
                                                      smartClassImg: schoolRecceController.imagePaths4.toString(),
                                                      projectorImg: schoolRecceController.imagePaths5.toString(),
                                                      computerImg: schoolRecceController.imagePaths6.toString(),
                                                      libraryExisting: schoolRecceController.getSelectedValue('existingLibrary') ?? '',
                                                      libImg: schoolRecceController.imagePaths7.toString(),
                                                      playGroundSpace: playGroundSpace,
                                                      spaceImg: schoolRecceController.imagePaths8.toString(),
                                                      enrollmentReport: jsonData.toString(),
                                                      enrollmentImg: schoolRecceController.imagePaths9.toString(),
                                                      academicYear: schoolRecceController.getSelectedValue('gradeReport') ?? '',
                                                      gradeReportYear1: staffJsonData.toString(),
                                                      gradeReportYear2: readingJson2.toString(),
                                                      gradeReportYear3: readingJson3.toString(),
                                                      DigiLabRoomImg: schoolRecceController.imagePaths10.toString(),
                                                      libRoomImg: schoolRecceController.imagePaths11.toString(),
